...
},{"./auth":7,"./cookie":8,"./pages/came-back-for.vue":9,"./pages/hey.vue":10,"./pages/its-me-isabell.vue":11,"./pages/middle-name.vue":12,"./pages/notebook.vue":13,"./pages/shook-a-little.vue":14,"./pages/tell-me.vue":15,"./pages/wait-for-me.vue":16,"vue":5,"vue-resource":3,"vue-router":4}],7:[function(require,module,exports){
'use strict';
...
module.exports = {
	...
	methods: {
		nextPage: function nextPage() {
			...
			this.$http.post('/api/came-back-for', { cameBackFor: this.cameBackFor }).then(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4c158c64", module.exports)
  } else {
    hotAPI.update("_v-4c158c64", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"wrapper flex columns\" v-cloak=\"\">\n\t<div class=\"content flex\">\n    \t<h2 class=\"witty-words flex columns\">\n    \t\t<span class=\"alfa-slab\">Hey! You're here!</span>\n\t\t\t<span class=\"josefin\">took you long enough... ;)</span>\n    \t</h2>\n\t</div>\n\n\t<div @click=\"nextPage()\" class=\"next flex\">\n\t\t<h2 class=\"glyphicon glyphicon-chevron-right\"></h2>\n\t</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-527a4ca6", module.exports)
  } else {
    hotAPI.update("_v-527a4ca6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-ade86b20", module.exports)
  } else {
    hotAPI.update("_v-ade86b20", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
module.exports = {
	...
	methods: {
		nextPage: function nextPage() {
			...
			this.$http.post('/api/middle-name', { middleName: this.middleName }).then(function (response) {
				if (_this.middleName.toLowerCase() == 'its me isabell' || _this.middleName.toLowerCase() == 'it\'s me isabell') {
					_this.$router.go('/its-me-isabell');
					return;
				}
				_this.$router.go(_this.next);
			}).catch(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-23251866", module.exports)
  } else {
    hotAPI.update("_v-23251866", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
module.exports = {
	...
	ready: function ready() {
		...
		this.$http.get('/server').then(function (response) {
			...
			_this.socket = io.connect(server.domain + ':' + server.port);
		}).then(function () {
	...
	methods: {
		...
		registerSocketEvents: function registerSocketEvents() {
			var _this2 = this;
			...
			this.socket.on('message-removed', function (removedMessage) {
				var message = _this2.messages.find(function (message) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-74757d7e", module.exports)
  } else {
    hotAPI.update("_v-74757d7e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
module.exports = {
	...
	methods: {
		nextPage: function nextPage() {
			...
			this.$http.post('/api/shook-a-little', { shookALittle: this.shookALittle }).then(function () {
				_this.$router.go(_this.next);
			}).catch(function () {
				_this.$router.go('/');
			});
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-483a339f", module.exports)
  } else {
    hotAPI.update("_v-483a339f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
module.exports = {
	...
	methods: {
		send: function send() {
			...
			this.$http.post('/api/tell-me', { text: this.text }).then(function () {
				_this.$router.go(_this.next);
			}).catch(function () {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-36282dbe", module.exports)
  } else {
    hotAPI.update("_v-36282dbe", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
module.exports = {
	...
	methods: {
		nextPage: function nextPage() {
			...
			this.$http.post('/api/wait-for-me', { username: this.username, password: this.password }).then(function () {
				_this.$router.go(_this.next);
			}).catch(function () {
				_this.$router.go('/');
			});
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1fbd0004", module.exports)
  } else {
    hotAPI.update("_v-1fbd0004", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
